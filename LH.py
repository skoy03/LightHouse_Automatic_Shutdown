...
#qmsg酱 PUSHPLUS推送配置
qmsgurl = os.environ["qmsgurl"]#qmsg酱私有云url地址:例:https://qmsg.zendee.cn，私有云架设教程：https://qmsg.zendee.cn/docs/plus/
qkey = os.environ["qkey"]
bot = os.environ["bot"]
qq = os.environ["qq"]
qun = os.environ["qun"]
plustoken = os.environ["plustoken"]
